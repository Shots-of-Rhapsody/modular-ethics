...
(function () {
  ...
  (function themeToggle () {
    ...
    const btn = $('#themeBtn') || document.querySelector('[data-theme-toggle]')
  ...
  (function mobileMenu () {
    ...
    const list = document.querySelector('.site-nav ul') || document.querySelector('.nav-links')
    ...
    const DESKTOP_MIN = 861 // matches CSS breakpoint
